...
class LowLevelCommandGenerator(CommandTerm):
    ...
    def __init__(self, cfg: LowLevelCommandGeneratorCfg, env: ManagerBasedRLEnv):
        ...
        self.objnav_policy_path = os.path.join(ISAAC_NUCLEUS_DIR, "low_level_policy", "mid_policy_height_scan.jit")
        self.objnav_policy_path = os.path.join(ISAAC_NUCLEUS_DIR, "low_level_policy", "mid_policy_depth.jit")
